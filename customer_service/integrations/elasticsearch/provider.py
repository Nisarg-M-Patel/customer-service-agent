...
"""Elasticsearch provider for advanced product search."""
...
class ElasticsearchProvider:
    """Elasticsearch provider for enhanced product search capabilities."""
    ...
    def __init__(self, config: Config):
        ...
        if not self.search_config:
            raise ValueError("No search configuration found. Run config generation first.")
    ...
    def _create_index(self):
        """Create Elasticsearch index with business-specific configuration."""
    ...
    def search_products(self, query: str = None, category: str = None, 
        ...
        """Search products using generated configuration."""
        ...
        try:
            ...
            logger.info(f"Search returned {len(products)} products for query: '{query}'")
            return products
